...
public class SHNewEmployeeForm extends BasePage {
    ...
    public SHNewEmployeeForm() {
        CommonEvents.waitUntilIsVisible(acceptNewEmployee);
    }
    ...
    public void isMessageCodeDuplicateShowed() {
        String messageShowed = CommonEvents.getTextContent(messageAlert);
        Assert.assertEquals(messageShowed, "El codigo de empleado " + PropertyAccessor.getInstance().getNewEmployeeCode() + " ya se encuentra asignado a otro empleado");
    }
